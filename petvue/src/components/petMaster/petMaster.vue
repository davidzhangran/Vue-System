        ...
        <el-dialog title="新增宠主详情" :visible.sync="dialogTableVisible" width="30%">
            ...
            <el-form status-icon v-model="petMaster" label-width="auto" class="petMaster">
                ...
                <el-form-item label="头像：" prop="banner">
                    <!-- <el-input v-model="petMaster.banner" autocomplete="off"></el-input> -->
        ...
        <el-table :data="petMarterData" border style="width: 100%">
            ...
            <el-table-column fixed="right" label="操作" width="150">
                <template slot-scope="scope">
                    ...
                    <el-button @click="editpetMaster(scope.row)" type="text" size="small">编辑</el-button>
                </template>
            </el-table-column>
        </el-table>
    </div>
...
const { mapActions } = createNamespacedHelpers("petMaster"); //具体到某一个仓库
